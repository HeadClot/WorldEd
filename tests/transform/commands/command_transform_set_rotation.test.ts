...
describe('CommandTransformSetRotation', () => {
  ...
  it('should snapshot original rotations on construction', () => {
    ...
    new CommandTransformSetRotation([mesh1], [newRotation]);
  ...
  it('should execute and set new rotations', () => {
    ...
    const command = new CommandTransformSetRotation([mesh1], [newRotation]);
    command.execute();
  ...
  it('should handle zero rotation values', () => {
    ...
    const command = new CommandTransformSetRotation([mesh2], [newRotation]);
    command.execute();
  ...
  it('should handle multiple objects with different rotations', () => {
    ...
    const command = new CommandTransformSetRotation([mesh1, mesh2], [rot1, rot2]);
    command.execute();
