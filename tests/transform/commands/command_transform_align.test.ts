...
import { CommandTransformAlign, ObjectAlignSnapshot } from '@/transform/commands/command_transform_align.js';
import { CommandStack } from '@/commands/command_stack.js';

describe('CommandTransformAlign', () => {
  ...
  it('should execute and move objects to target positions', () => {
    const command = new CommandTransformAlign(snapshots, targets);
    command.execute();
  ...
  it('should be a no-op when target equals current position', () => {
    ...
    const command = new CommandTransformAlign(snapshots, sameTargets);
    command.execute();
    expect(mesh1.position.x).toBeCloseTo(1);
    expect(mesh1.position.y).toBeCloseTo(2);
    expect(mesh1.position.z).toBeCloseTo(3);
  ...
  it('should align only X axis when target differs only on X', () => {
    ...
    const command = new CommandTransformAlign(snapshots, xOnlyTargets);
    command.execute();
    expect(mesh1.position.x).toBeCloseTo(10);
    expect(mesh1.position.y).toBeCloseTo(2);
    expect(mesh1.position.z).toBeCloseTo(3);
  ...
  it('should align only Y axis when target differs only on Y', () => {
    ...
    const command = new CommandTransformAlign(snapshots, yOnlyTargets);
    command.execute();
    expect(mesh1.position.x).toBeCloseTo(1);
    expect(mesh1.position.y).toBeCloseTo(20);
    expect(mesh1.position.z).toBeCloseTo(3);
  ...
  it('should align only Z axis when target differs only on Z', () => {
    ...
    const command = new CommandTransformAlign(snapshots, zOnlyTargets);
    command.execute();
    expect(mesh1.position.x).toBeCloseTo(1);
    expect(mesh1.position.y).toBeCloseTo(2);
    expect(mesh1.position.z).toBeCloseTo(30);
  ...
  it('should not modify axes not in the target map', () => {
    ...
    const command = new CommandTransformAlign(singleSnapshot, partialTargets);
    command.execute();
    expect(mesh1.position.x).toBeCloseTo(10);
    expect(mesh1.position.y).toBeCloseTo(20);
    expect(mesh1.position.z).toBeCloseTo(30);
  ...
  it('should handle empty snapshot array gracefully', () => {
    ...
    const command = new CommandTransformAlign(emptySnapshots, emptyTargets);
    command.execute();
    command.undo();
    expect(mesh1.position.x).toBeCloseTo(1);
    expect(mesh2.position.x).toBeCloseTo(4);
