...
describe('CommandTransformRotationSet', () => {
  ...
  it('should snapshot original rotations on construction', () => {
    ...
    new CommandTransformRotationSet([mesh1], [newRotation]);
  ...
  it('should execute and set new rotations', () => {
    ...
    const command = new CommandTransformRotationSet([mesh1], [newRotation]);
    command.execute();
  ...
  it('should handle zero rotation values', () => {
    ...
    const command = new CommandTransformRotationSet([mesh2], [newRotation]);
    command.execute();
  ...
  it('should handle multiple objects with different rotations', () => {
    ...
    const command = new CommandTransformRotationSet([mesh1, mesh2], [rot1, rot2]);
    command.execute();
