...
describe('CommandTransformPositionSet', () => {
  ...
  it('should snapshot original positions on construction', () => {
    ...
    new CommandTransformPositionSet([mesh1, mesh2], [newPosition1, newPosition2]);
  ...
  it('should execute and set new positions', () => {
    const newPosition1 = new THREE.Vector3(10, 20, 30);
    const newPosition2 = new THREE.Vector3(40, 50, 60);
    const command = new CommandTransformPositionSet([mesh1, mesh2], [newPosition1, newPosition2]);
    command.execute();
  ...
  it('should undo and restore original positions', () => {
    ...
    const command = new CommandTransformPositionSet([mesh1], [newPosition]);
    command.execute();
  ...
  it('should work with Object3D groups', () => {
    ...
    const newPosition = new THREE.Vector3(100, 200, 300);
    const command = new CommandTransformPositionSet([group], [newPosition]);
    command.execute();
