...
describe('CommandTransformScaleSet', () => {
  ...
  it('should snapshot original scale on construction', () => {
    ...
    new CommandTransformScaleSet([mesh1], [newScale]);
  ...
  it('should execute and set new scale', () => {
    ...
    const command = new CommandTransformScaleSet([mesh1], [newScale]);
    command.execute();
  ...
  it('should handle non-uniform scale', () => {
    ...
    const command = new CommandTransformScaleSet([mesh2], [newScale]);
    command.execute();
  ...
  it('should handle multiple objects with different scales', () => {
    ...
    const command = new CommandTransformScaleSet([mesh1, mesh2], [scale1, scale2]);
    command.execute();
