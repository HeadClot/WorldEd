...
import { TextureAssignmentController } from '../../../src/managers/texture/texture_assignment_controller.js';
...
import { getDefaultCheckerBrowserEntry } from '../../../src/texture/library/default_checker_entry.js';
import {
  setTexturePaintStateForTests,
  TexturePaintState,
  getTexturePaintState,
} from '../../../src/texture/paint/texture_paint_state.js';
import { setTextureMapCacheForTests, TextureMapCache } from '../../../src/texture/library/texture_map_cache.js';
import { createTextureBrowserEntry } from '../../../src/texture/library/texture_browser_entry.js';
import { mockObjectUrlApis } from '../../texture/library/object_url_test_utils.js';
