...
import { AlignmentController } from '../../../src/managers/hierarchy/alignment_controller.js';
...
describe('AlignmentController', () => {
  ...
  beforeEach(() => {
    ...
    targetMesh = new THREE.Mesh(new THREE.BoxGeometry(1, 1, 1), new THREE.MeshStandardMaterial({ color: 0xaaaaaa }));
