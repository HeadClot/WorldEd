...
import { buildTargetsFromFaceSelection, initializeMeshTextureUVs } from '@/texture/uv/face_texture_applier.js';
 ...
 */
describe('CommandTextureFaceApply multi-select', () => {
  it('applies relative scale to every selected solid face in one command', () => {
    ...
    const selection = new ManagerFaceSelection();
    ...
    new CommandTextureFaceApply(targets, undefined, {
