...
} from '@/texture/ui/browser/texture_browser.js';
import {
  TEXTURE_BROWSER_THUMB_CLASS,
  TEXTURE_BROWSER_GRID_CLASS,
  TEXTURE_BROWSER_MIN_TRACK_PX,
} from '@/texture/ui/browser/texture_browser_styles.js';
...
describe('TextureBrowser', () => {
  ...
  let onOpenFolder: ReturnType<typeof vi.fn<() => void>>;
  let onSelectTexture: ReturnType<typeof vi.fn<(entryId: string) => void>>;
