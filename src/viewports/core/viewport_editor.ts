...
export type ViewportEditor = Viewport2D | Viewport3D;
 ...
 */
export function isPerspectiveViewport(viewport: ViewportEditor): viewport is Viewport3D {
 ...
 */
export function isOrthographicViewport(viewport: ViewportEditor): viewport is Viewport2D {
