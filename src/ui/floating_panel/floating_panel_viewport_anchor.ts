 ...
 */
export function resolveFloatingPanelAnchorViewport(viewports: readonly EditorViewport[]): EditorViewport | null {
 ...
 */
export function resolveFloatingPanelAnchorElement(viewports: readonly EditorViewport[]): HTMLElement | null {
 ...
 */
function pickLargestViewportByClientArea(viewports: readonly EditorViewport[]): EditorViewport {
 ...
 */
function pickTopLeftViewport(viewports: readonly EditorViewport[]): EditorViewport {
  let best = viewports[0]!;
 ...
 */
function measureViewportClientArea(viewport: EditorViewport): number {
