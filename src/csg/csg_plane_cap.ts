...
export function buildPlaneCapPolygon(
  ...
  const intersectionPoints = collectPlaneIntersectionPoints(sourcePolygons, planeNormal, planeConstant);
 ...
 */
function removeCollinearRingPoints(ordered: THREE.Vector3[], planeNormal: THREE.Vector3): THREE.Vector3[] {
 ...
 */
function addOnPlaneVertex(vertex: THREE.Vector3, signedDistance: number, unique: Map<string, THREE.Vector3>): void {
