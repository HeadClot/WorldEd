...
/**
 * Performs BSP-based CSG boolean operations on mesh pairs. Suitable for
...
export class CsgBooleanOps {
   ...
   */
  operate(meshA: THREE.Mesh, meshB: THREE.Mesh, operation: CsgOperation, resultName: string): THREE.Mesh | null {
