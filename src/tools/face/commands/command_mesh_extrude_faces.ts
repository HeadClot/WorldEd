 ...
 */
export class CommandMeshExtrudeFaces implements UndoCommand {
   ...
   */
  static fromMeshes(createdMeshes: THREE.Mesh[], parent: THREE.Object3D): CommandMeshExtrudeFaces {
    return new CommandMeshExtrudeFaces(createdMeshes.map((mesh) => ({ kind: 'mesh' as const, mesh, parent })));
  }
