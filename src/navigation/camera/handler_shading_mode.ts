 ...
 */
export class HandlerShadingMode {
  private controllers: ControllerViewportShading[];
   ...
   */
  constructor(controllers: ControllerViewportShading[], activeViewportIndex: number, statusBar: StatusBar | null) {
