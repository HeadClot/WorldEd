...
export const SOLID_ALGORITHM_ROUTING_CATEGORY_COUNT = 6;
 ...
 */
export interface SolidAlgorithmRoutingStep {
...
export class SolidAlgorithmRoutingTable {
  readonly steps: readonly SolidAlgorithmRoutingStep[];
   ...
   */
  constructor(steps: SolidAlgorithmRoutingStep[], invertedWorld: boolean) {
    this.steps = steps;
