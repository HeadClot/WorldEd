...
/**
 * Maps a triangle on a solid brush preview mesh to a wing-edge brush face
 * index. Three.js BoxGeometry face order does not match our solid brush face
 * order, so matching is done by comparing triangle normals to brush plane
 * normals.
 *
