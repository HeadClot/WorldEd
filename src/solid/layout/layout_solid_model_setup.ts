...
export interface SolidModelLayoutSetup {
  solidModelPanel: PanelSolidModel;
...
export function setupSolidModelLayout(host: SolidModelLayoutHost): SolidModelLayoutSetup {
  const solidModelPanel = new PanelSolidModel(
  ...
  const solidModelController = new ControllerSolidModel(
    host.worldObject,
    host.commandStack,
 ...
 */
function wireSolidModelController(host: SolidModelLayoutHost, controller: ControllerSolidModel): void {
 ...
 * @param controller Solid model controller.
 */
function wireSolidBrushPropertyHandlers(propertiesPanel: PanelProperties, controller: ControllerSolidModel): void {
