...
import type { ObjExportPackage } from '@/io/obj/obj_export_types.js';
import type { FbxExportPackage } from '@/io/fbx/fbx_export_types.js';
 ...
 */
export class ManagerFileDialog {
  /**
