...
export class ExtrudeFacesCommand implements UndoCommand {
   ...
   */
  static fromMeshes(createdMeshes: THREE.Mesh[], parent: THREE.Object3D): ExtrudeFacesCommand {
    return new ExtrudeFacesCommand(createdMeshes.map((mesh) => ({ kind: 'mesh' as const, mesh, parent })));
  }
