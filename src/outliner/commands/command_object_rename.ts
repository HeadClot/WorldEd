...
/**
 * Undoable command for renaming a Three.js object. Stores the previous name to
 * support undo restoration.
 */
export class CommandObjectRename implements UndoCommand {
