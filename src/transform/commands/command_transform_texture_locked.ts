...
import { restoreTransformTextureState, type TransformTextureSnapshot } from './state_transform_texture.js';
 ...
 */
export class CommandTransformTextureLocked implements UndoCommand {
