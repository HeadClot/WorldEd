import type { SerializedAreaLayout } from '../area/area_layout_serializer.js';
import {
  createDualTopPerspectiveLayout,
  createQuadLayout,
  createSinglePerspectiveLayout,
  createTripleLayout,
} from '../area/area_layout_presets.js';
import { serializeAreaLayout } from '../area/area_layout_serializer.js';
