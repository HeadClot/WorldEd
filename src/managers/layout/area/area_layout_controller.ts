...
import { AreaIdFactory } from './area_id_factory.js';
...
import { checkAreaJoin } from './area_join_policy.js';
 ...
 * placements.
 */
export class AreaLayoutController {
  private readonly layoutDom: AreaLayoutDom;
  private readonly idFactory: AreaIdFactory;
  ...
  constructor(paneLayer: HTMLElement, initialRoot: AreaTreeNode = createQuadLayout()) {
    ...
    this.idFactory = new AreaIdFactory();
