 ...
 */
export interface ModalToolSession {
 ...
 * effects.
 */
export class ModalToolSessionRegistry {
  private sessions: Map<string, ModalToolSession>;
   ...
   */
  register(session: ModalToolSession): void {
