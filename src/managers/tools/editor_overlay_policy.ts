...
export type EditorOverlayPolicyListener = () => void;
 ...
 */
export class EditorOverlayPolicy {
  private suppressions: Map<EditorOverlayId, Set<string>>;
  private listeners: EditorOverlayPolicyListener[];
   ...
   */
  addChangeListener(listener: EditorOverlayPolicyListener): void {
   ...
   */
  removeChangeListener(listener: EditorOverlayPolicyListener): void {
