...
import { CsgMeshBuilder } from '../../csg/csg_mesh_builder.js';
...
import { getTriangleCount } from '../../selection/pick/triangle_geometry_utils.js';
...
const sharedMeshBuilder = new CsgMeshBuilder();
