...
import type { AnisotropyPreference, TextureFilterMode } from '../../settings/settings_types.js';
 ...
 */
export interface TextureFilterPolicy {
 ...
 */
export function resolveAnisotropyLevel(policy: TextureFilterPolicy): number {
 ...
 */
export function applyTextureFilterPolicy(texture: THREE.Texture, policy: TextureFilterPolicy): void {
