...
| Unreal Engine  | Left-handed, Z-up, `+X` forward                         | Centimeter profile                    | Preserve the exported hierarchy; disable Convert Scene, enable Force Front X Axis, and avoid extra import rotation. |
